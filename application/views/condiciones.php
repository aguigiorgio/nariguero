<div class="row">
  ...
  <div class="col-md-12">
    ...
    <p style="text-align:justify">
      ...
      a continuación se redactan. El uso de nuestros servicios así como la compra
      de nuestros productos implicará que usted ha leído y aceptado los Términos
      y Condiciones de Uso en el presente documento. Todas los productos  que son
      ...
      sea necesario para la compra de alguno de nuestros productos. <b>nariconfort.com</b>
      ...
      condiciones requeridas por el medio de pago seleccionado. En algunos casos
    ...
    <h3>LICENCIA</h3>
    <p style="text-align:justify">
      <b>Nariconfort</b>  a través de su sitio web concede una licencia para que los
    ...
    <p style="text-align:justify">
      ...
      indirectos, especiales, fortuitos o consecuentes u otras pérdidas
      resultantes del uso o de la imposibilidad de utilizar nuestros productos.
    </p>
    <h3>POLÍTICA DE REEMBOLSO Y GARANTÍA</h3>
    <p style="text-align:justify">
      En el caso de productos que sean  mercancías irrevocables no-tangibles,
      no realizamos reembolsos después de que se envíe el producto, usted tiene
      ...
      haya usado correctamente. La garantía no cubre averías o daños ocasionados
    ...
    <h3>PRIVACIDAD</h3>
    <p style="text-align:justify">
      Este sitio web <b>nariconfort.com</b> garantiza que la información personal que
      usted envía cuenta con la seguridad necesaria. Los datos ingresados por
      ...
      <b>Nariconfort</b> reserva los derechos de cambiar o de modificar estos términos sin previo aviso.
    </p>
  </div>
</div>
